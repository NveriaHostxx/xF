...
message.author.send(`**مدة الرابط : يوم عدد الاستخدامات : لا محدود**`)
...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== '425773623249338379') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '425773623249338379') return;
...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NTQyNTA0NDI0NTM5NDIyNzcw.D1DpCw.Yn8QE1JWhbxtQvaqHoM6BGxN-7Y'; // التوكن هنا بس
      if(message.content === '!restart') {
if(message.author.id !== '425773623249338379') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
...
.setFooter(message.author.username, message.author.avatarURL)  
 ...
 client.on('message', message => {
    ...
    client.guilds.get("542504424539422770").members.get("425773623249338379").sendMessage(message.author.tag+"\n Message : "+args)
